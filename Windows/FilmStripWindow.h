#ifndef FILMSTRIPWINDOW_H
#define FILMSTRIPWINDOW_H
...
namespace Ui {
    class FilmStripWindow;
}

class FilmStripWindow: public QMainWindow {
    Q_OBJECT
    enum {
        TRAIN,
        EXCUTE
...
public:
    explicit FilmStripWindow( QWidget *parent = nullptr );
    ~FilmStripWindow();
